...
public class TaskTestData {
    ...
    public static final TaskToFull taskToFull1 = new TaskToFull(
            TASK1_ID, "epic-1", "Data", null, "epic", "in_progress", "normal", null, 4, null, new CodeTo(PROJECT1_ID, "PR1"), new CodeTo(SPRINT1_ID, "SP-1.001"), Collections.emptySet(), null);
    public static final TaskToFull taskToFull2 = new TaskToFull(
            TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "ready_for_review", "high", null, 4, null, new CodeTo(PROJECT1_ID, "PR1"), new CodeTo(SPRINT1_ID, "SP-1.001"), Collections.emptySet(), null);
